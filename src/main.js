...
const createFormTemplate = (isFirstEvent, isEditEvent, isEventWithDestination) => {
  let event =
  ...
  if (!isFirstEvent) {
    ...
    if (isEventWithDestination === true) {
      event +=
...
render(tripSort, createFormTemplate(false, false, true), `afterend`);
